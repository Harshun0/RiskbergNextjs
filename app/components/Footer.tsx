...
export default function Footer() {
  return (
    <footer className="site-footer" id="footer">
      {/* Brand watermark */}
      <svg className="footer-watermark" viewBox="0 0 400 300" aria-hidden="true">
        <path d="M0 300 L110 90 L175 200 L230 60 L400 300 Z" fill="#539AD2" />
        <path d="M175 200 L230 60 L400 300 L175 300 Z" fill="#0F1F3F" />
      </svg>
        ...
        <div className="footer-outer">
          ...
          <div className="footer-left">
            <div className="footer-grid">
              ...
              <div className="footer-links">
                ...
                <ul>
                  <li><Link href="/insights">News &amp; Articles</Link></li>
                  <li><Link href="/insights#resources">Resources</Link></li>
            ...
            {/* ISO certification badges — full-width centered row */}
            <div className="footer-iso-strip" aria-label="Certifications">
              {['iso1.png','iso2.png','iso3.png','iso4.jpg','iso5.png'].map((file) => (
                <img
                  key={file}
                  src={`/PartnersKing/${file}`}
                  alt={file.replace(/\.[^.]+$/, '').toUpperCase()}
                  className="footer-iso-badge"
                  style={file === 'iso5.png' ? { height: '72px' } : undefined}
                  loading="lazy"
                  decoding="async"
                />
              ))}
          ...
          <div className="footer-right" aria-hidden="true">
            <img
              src="/csss.png"
              alt=""
              style={{ width: '100%', height: '100%', maxWidth: '720px', objectFit: 'contain' }}
            />
          </div>
